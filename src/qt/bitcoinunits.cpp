...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("SustainCoins"));
    case mBTC: return QString(QObject::tr("Milli-SustainCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-SustainCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
