...
const string strMessageMagic = "SustainCoin Signed Message:\n";
...
void ThreadScriptCheck(void*) {
    ...
    RenameThread("SustainCoin-scriptch");
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in SustainCoin
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // SustainCoin: check proof-of-stake block signature
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "SustainCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "SustainCoin Genesis Block";
        CTransaction txNew;
        txNew.nTime = 1479317664;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1479317665;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 698184 : 9999999;
	   ...
	   if (fTestNet && (block.GetHash() != hashGenesisBlock)) {
        ...
        //// debug print
		if (!fTestNet) {
			assert(block.hashMerkleRoot == uint256("0x6b116d1aa2cd80e61f6e858805f817ce65b4aee33a251119306ad1b67ce6750c"));
...
unsigned char pchMessageStart[4] = { 0xb9, 0xf8, 0xe2, 0xe5 };
